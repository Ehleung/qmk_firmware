...
[1] = LAYOUT(
        ...
        KC_NO,   RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SN,RGB_M_K, RGB_M_X, RGB_M_G, KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, KC_NO,   KC_NO,     RGB_MOD, BL_INC,  KC_VOLU, \
        KC_NO,   KC_NO,   KC_NO,   RGB_VAI, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_NO,   KC_NO,     RGB_RMOD,BL_DEC,  KC_VOLD, \
        MAGIC_CAPSLOCK_TO_CONTROL, KC_NO, RGB_SPD, RGB_VAD, RGB_SPI, KC_NO, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PDOT, KC_PENT, \
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, MAGIC_TOGGLE_NKRO, KC_NO, KC_P1, KC_P2, KC_P3, KC_NO, RGB_SAI, \
        MAGIC_UNCAPSLOCK_TO_CONTROL, KC_NO, KC_NO, KC_NO, KC_P0, KC_TRNS, KC_NO, KC_NO, RGB_HUD, RGB_SAD, RGB_HUI)
    /*
    [X] = LAYOUT(
